...
from pairo_butler.keypoint_detection.models.detector import KeypointDetector
...
if __name__ == "__main__":
    pool = get_model_from_wandb_checkpoint(
        "tlips/synthetic-cloth-keypoints-tshirts/model-4um302zo:v0"
    )
    print(pool.hparams)
