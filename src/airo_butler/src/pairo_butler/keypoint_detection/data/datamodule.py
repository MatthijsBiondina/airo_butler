...
from pairo_butler.keypoint_detection.data.coco_dataset import COCOKeypointsDataset
        ...
        **kwargs,
        ...
        if json_validation_dataset_path:
            ...
            if self.train_dataset is not None:
                print(
                    f"splitting the train set to create a validation set with ratio {validation_split_ratio} "
                )
                (
                    self.train_dataset,
            ...
            train_transform = MultiChannelKeypointsCompose(
                [
                    ...
                    A.RandomResizedCrop(
                        ...
                        img_width,
                        scale=(0.8, 1.0),
                        ratio=(0.9 * aspect_ratio, 1.1 * aspect_ratio),
                        p=1.0,
                    ),
